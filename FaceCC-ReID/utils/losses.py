...
def make_loss(cfg, num_classes):
    ...
    triplet = TripletWithFaceLoss(0.3)  # triplet loss
    ...
    def loss_func(score, feat, score_face, feat_face, target, target_face):      # [64, 751],  [64, 512], [64,]
        ...
        loss_t = triplet(feat, feat_face, target, target_face)[0]    # 3.2403
        loss_f = ft_loss(feat[0: B], feat[B:])      # 0.99
        loss = loss_x + loss_t + loss_f + 0.5 * loss_x_face     # 11.1710
